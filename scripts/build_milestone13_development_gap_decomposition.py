...
def build_gap_panel() -> tuple[list[dict[str, Any]], dict[str, float], list[str]]:
    ...
    for key in sorted(m11_by_key, key=lambda item: (TARGETS.index(item[0]), item[1], int(item[2]))):
        ...
        output.append({
            ...
            "m11_benchmark_qualified": m12["m11_benchmark_qualified"],
            "m11_support_warning": m12["m11_support_warning"],
            "m12_primary_frontier_calibrated": m12["primary_frontier_calibrated"],
